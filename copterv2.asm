...
.DATA
	...
	newGameMsg db "- Start New Game$"
	exitGameMsg db " Exit Game$"
	scoreMsg db "Score$"
	bestscoreMsg db "Best$"
	chooseLevel db "Choose Level : $"
	level1		db " - Level 1$"
	level2		db " - Level 2$"
	level3		db " - Level 3$"
...
DrawObstacle PROC
		...
		outerLoop4:
			...
			innerLoop4:
				...
				DrawPixel linecolor, print_row, print_col
				inc 	col
				inc 	print_col
